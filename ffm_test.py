...
class Ours:
    ...
    def get_competition_submit(self, data160k_dir='D://dataset/university-160k-wx', save_file = 'answer.txt', pth=None, multiple_scale=[1], batchsize=128, block=4, MLPN_file='MLPN_200.pth', DC_file='DomainClassifier_060.pth', FFM_file='FFM_200.pth',h=256, w=256):
...
if __name__ == '__main__':
    ...
    m.get_competition_submit(data160k_dir='/dataset/university-160k-wx')