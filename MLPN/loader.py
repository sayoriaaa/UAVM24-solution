...
def init_dataset_train(data_dir, w=256, h=256, pad=10, batchsize=8, style='mixed', num_worker=4):
    ...
    dataloaders = {
        'satellite': torch.utils.data.DataLoader(image_datasets['satellite'], batch_size=batchsize, shuffle=True, num_workers=0, pin_memory=False),
