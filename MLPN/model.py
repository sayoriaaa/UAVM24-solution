...
class CSWinTransv2_threeIn(nn.Module):
    ...
    def __init__(self, class_num, droprate, decouple, infonce, block=4):
        ...
        # model_ft = timm.create_model('swinv2_base_window12to16_192to256_22kft1k', pretrained=False)
        # model_ft = timm.create_model('swinv2_base_window12to16_192to256_22kft1k', pretrained=True, pretrained_cfg_overlay=dict(file="./hub/checkpoints/swinv2_base_patch4_window12to16_192to256_22kto1k_ft.pth"))
