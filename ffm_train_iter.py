...
class WeatherFilter(nn.Module):
    def __init__(self, domin_num=10, h=256, w=256, channel=3) -> None:
        ...
        self.learnable_filters = nn.Parameter(torch.ones(domin_num, channel, h, w))
...
class Ours:
    ...
    def train(self, 
        ...
        # register ffm param to optimizer
        optimizer_ffm = optim.Adam(ffm.parameters(), lr=ffm_lr)
        ...
        for epoch in range(1, num_epochs+1):
            ...
            if epoch > 1 and epoch % opt_iter_epoch ==0 :
                opt_MLPN = not opt_MLPN 
            ...
            print('{} Loss: {:.4f} Satellite_Acc: {:.4f} Drone_Acc: {:.4f} infoloss1: {:.4f} '.format(
                ...
                epoch_acc3, epoch_loss_info1), 'Optimizing', 'MLPN' if opt_MLPN else 'FFM')
